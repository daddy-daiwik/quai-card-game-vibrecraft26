    ...
    <div className="min-h-screen bg-black text-slate-200 font-sans selection:bg-yellow-500/50">
      ...
      <header className="h-16 bg-slate-900 border-b border-slate-800 flex justify-between items-center px-6 sticky top-0 z-30 shadow-2xl">
        <div className="flex items-center space-x-6">
          <button onClick={leaveLobby} className="hover:text-white text-slate-500 transition-colors"><Home size={24}/></button>
          <div className="flex flex-col">
              <span className="text-[10px] uppercase text-slate-500 font-bold tracking-widest">Zone ID</span>
              <span className="text-xl font-black text-white italic leading-none">#{gameState.gameId}</span>
          </div>
        </div>
